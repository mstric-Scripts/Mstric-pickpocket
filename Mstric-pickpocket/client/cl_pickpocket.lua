...
local function pickPocket(data)
    ...
    then
        TriggerServerEvent('Mstric_pickpocket:server:pickPocketNpc', NetworkGetNetworkIdFromEntity(data.entity))
...
lib.callback.register('Mstric_pickpocket:client:getZoneName', function(coords)
    return GetNameOfZone(coords.x, coords.y, coords.z)
end)

RegisterNetEvent('Mstric_pickpocket:client:failedPickpocket', function(netId)
